...
const CreateAsset = () => {
  ...
  const handleAddAsset = async () => {
    ...
    const response = await (contract!.connect(signer!) as Contract).addAsset!(
      propertyName,
      aboutText,
      propertyValue,
      2,
    ...
    <div className="mb-8 py-8 px-4 flex flex-col items-center">
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-4">
          <label htmlFor="property-name" className="mb-2 block">
            Property name
          </label>
          <input
            id="property-name"
            className="w-full max-w-[300px] border px-4 py-2 rounded-lg mb-4"
            type="text"
            placeholder="Great Suites"
            onChange={handleNameChange}
            value={propertyName || ""}
          />

          <label htmlFor="property-value" className="mb-2 block">
            Property value (BNB)
          </label>
          <input
            id="property-value"
          ...
          <label htmlFor="rent-per-year" className="mb-2 block">
            Rentper year (BNB)
          </label>
          <input
            className="w-full max-w-[300px] border px-4 py-2 rounded-lg mb-4"
          ...
          <button
            ...
            className="p-4 px-8 rounded-full bg-black text-white text-sm mx-auto self-center"
          >
            Add Asset
          </button>
        </div>
        ...
        <div className="col-span-8">
          <label htmlFor="property-about-text" className="mb-2 block">
